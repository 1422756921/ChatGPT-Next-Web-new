  ...
  Error: {
    Unauthorized: isApp
      ? `😆 对话遇到了一些问题，不用慌:
       ...
       \\ 2️⃣ 需要key联系QQ：[1422756921](http://wpa.qq.com/msgrd?v=3&uin=1422756921&site=qq&menu=yes)。[青云博客](https://blog.aerr.cn)`
      : `😆 对话遇到了一些问题，不用慌:
       \ 1️⃣ 如果你正在使用私有部署版本，点击[这里](/#/auth)输入访问秘钥 🔑
       \ 2️⃣ 如果你想消耗自己的 OpenAI 资源，点击[这里](/#/settings)修改设置 ⚙️
       \ 3️⃣ 需要key联系QQ：[1422756921](http://wpa.qq.com/msgrd?v=3&uin=1422756921&site=qq&menu=yes)。[青云博客](https://blog.aerr.cn)
       `,
  },
  Auth: {
    Return: "返回",
